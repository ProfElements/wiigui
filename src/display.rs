...
use ogc_rs::{
    ffi::{
        ...
        GX_ORTHOGRAPHIC, GX_PASSCLR, GX_PF_RGB8_Z24, GX_PF_RGBA6_Z24, GX_PNMTX0, GX_POS_XYZ,
        GX_RGBA8, GX_TEVSTAGE0, GX_TEXCOORD0, GX_TEXMAP0, GX_TEX_ST, GX_VA_CLR0, GX_VA_POS,
        GX_VA_TEX0, GX_VTXFMT0, GX_ZC_LINEAR,
    },
...
impl Display {
    ...
    pub fn setup(&self, rc: &mut RenderConfig) {
        ...
        Gx::set_pixel_fmt(GX_PF_RGBA6_Z24 as _, GX_ZC_LINEAR as _);
        Gx::set_viewport(
            0.0,
            0.0,
